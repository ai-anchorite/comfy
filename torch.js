    ...
    },
    {
      ...
      "params": {
        ...
        "message": [
          ...
          "uv pip install https://huggingface.co/lldacing/flash-attention-windows-wheel/resolve/main/flash_attn-2.7.4%2Bcu126torch2.6.0cxx11abiFALSE-cp310-cp310-win_amd64.whl --force-reinstall"
        ]
      },
      "next": null
    },
    {
      ...
      "params": {
        ...
        "message": [
          "uv pip install torch==2.6.0 torchvision torchaudio {{args && args.xformers ? 'xformers' : ''}}  --index-url https://download.pytorch.org/whl/cu126 --force-reinstall",
          "uv pip install git+https://github.com/thu-ml/SageAttention.git",
          "uv pip install https://github.com/Dao-AILab/flash-attention/releases/download/v2.7.4.post1/flash_attn-2.7.4.post1+cu12torch2.6cxx11abiTRUE-cp310-cp310-linux_x86_64.whl --force-reinstall"
        ]
      },
      "next": null
    },
